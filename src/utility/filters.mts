...
export const filters = [
  ...
  [
    "Haas Left",
    "extrastereo=m=0:haas=middle_source=left",
    "Make the 'left' sound echo more"
  ],
  [
    "Haas Middle",
    "extrastereo=m=0:haas=middle_source=mid",
    "Make the 'middle' sound echo more"
  ],
  [
    "Haas Right",
    "extrastereo=m=0:haas=middle_source=right",
    "Make the 'right' sound echo more"
  ],
  ["Pan Left", "stereotools=mpan=-0.75", "Make it sound from the left"],
  [
    "Pan Middle",
    "stereotools=mpan=0",
    "Make it sound from the center (normal)"
  ],
  ...
  [
    "Low Bass",
    "bass=g=-20",
    "Significantly reduce the bass (for mobile users)"
  ],
  ...
  [
    "Subboost",
    "asubboost=boost=12",
    "Boosts tiny details or low vocals in the sound"
  ],
  ...
  [
    "Nightcore",
    "aresample=48000,asetrate=48000*1.2",
    "Speed it up, clip it, That's nightcore"
  ],
